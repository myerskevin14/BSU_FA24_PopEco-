...
# Answer:# Answer: After plotting both models, m1 seems like a more simple approach, using a multinomial likelihood based on the abundance. Whereas m2 used a more detailed conditional multinomial method, distinguishing between observed and unobserved individuals. The second model gives better flexibility for handling partial detentions. Overall, plotting both models resulted in relatively similar graphs.   
