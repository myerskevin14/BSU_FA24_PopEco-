...
# Answer: The cheatgrass data look normally distributed while sagebrush data are skewed right. Higher coverage of sagebrush had fewer squirrels counted so the ability to predict squirrel abundance in thicker shrub habitat is less reliable than in more open landscapes. The Feb. min temp data shows a significant gap between  -11 and-8 and high counts for -12. The AprMay. max temp data also has gaps in the count data.
#
...
# Any notable sites? 
# Answer: Overall, cheatgrass counts were fairly consistent. Site 78 had the most cheatgrass counted in 2014 and has has consistently high levels of cheatgrass over the last several years. Site 3 had the most sagebrush cover throughout the study but had very little oversevations of squirrels. 2011 and 2018 had the warmest minimum temperatures in February where as 2010, 2012, and 2013 had the coldest. 2009 had the warmest maximum temperatures in April/May where as 2011 had the coldest.  
#
...
# Answer: None of the correlations in the data are particularly strong. The highest correlation is between Feb.minT and AprMay.maxT at 0.40689126 a weak positive correlation. 
