...
# Answer: I chose to run the second model (m2) because it has more robust parameter estimates that could shed more light on the detection and abundance processes. 
#
...
m1 <- autojags( win.data, inits = inits, params, modelname, 
                ...
                iter.increment = 1000, max.iter = 5000, #change to less the 500k
                Rhat.limit = 0.8, #change to a more relaxed value - smaller 
